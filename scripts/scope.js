...
var x = 1;
// STEP 2: Build a function that accepts no parameters, 
// and also declares and intializes a variable within it (y = 2)
function fun1() {
    var y = 2;
    output(y);
}
// STEP 3: Build another function that also accepts 
// no parameters, and also declares and intializes a variable within it (z = 3)
function fun2() {
    var z = 3;
    output(z);
    output(x);
